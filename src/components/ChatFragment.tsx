...
import {Button, Box, Text, Flex, Spinner, VStack, Stack} from '@chakra-ui/react';
...
export function ChatFragment() {
    ...
    const handleServerResponse = (response) => {
        ...
        setSpeakQueue(prev => [...prev, ...sentences.filter(s => s.trim())]);
    };
        ...
        <Flex h="55vh" bg="gray.50" p="1" flexDirection="column" w="100%" pt="3vh" justifyContent="space-between">
            ...
            <Flex flexDirection="column" >
                <Flex justifyContent="space-around">
                    ...
                    <Button onClick={() => buttonMessage('그렇지 않다')} p={0}  h="4vh" flex="1" m={3}  rounded="lg"
                    ...
                    <Button onClick={() => buttonMessage('주 2-3 회 정도 그렇다')} p={0}  h="4vh" flex="1" m={3}  rounded="lg"
                    ...
                    <Button onClick={() => buttonMessage('주 3-5 회 정도 그렇다')} p={0}  h="4vh" flex="1" m={3}  rounded="lg"
                    ...
                    <Button onClick={() => buttonMessage(' 거의 매일 그렇다')} p={0}  h="4vh" flex="1" m={3}  rounded="lg"
                ...
                <Flex mt={4} justify="center" align="center" gap={4} bg="white" p={4} rounded="lg" h="8vh" flexDirection="row"  justifyContent="space-around">
                    <Stack flexDirection="row" flex="1" justifyContent="flex-end">
                        ...
                        <Button onClick={handleStartListening} p={3} rounded="full" w="4vh" h="4vh"
                                bg={isListening || isLoading ? 'red.500' : 'blue.500'}
                                className={isListening || isLoading ? 'animate-pulse' : ''}
                    ...
                    <Stack flexDirection="row" flex="1" justifyContent="space-between">
                        <Button onClick={synthCancel} p={3} rounded="full" w="4vh" h="4vh"
                                >

                            <MicIcon size={3} color="white" />
                        </Button>
                        <Button onClick={() => buttonMessage('검진')} p={0}  h="4vh"  m={0} bg="blue.500"  rounded="lg" w="10vh"
                        >
                            대화형 검진
                        </Button>
                    </Stack>
